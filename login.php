...
<body>
    ...
    <form action="" method="post">
      ...
      <div class="content">
        <div class="input-field username">
          <input type="username" name="username" id="username" placeholder="Username" autocomplete="nope">
        </div>
        <div class="input-field password">
          <input type="password" name="password" id="password" placeholder="Password" autocomplete="new-password">
        </div>
        <a href="register.php" class="link">Does not have an account? Sign Up</a>
  ...
  <!-- partial -->
  <script src="main_jain.js"></script>
